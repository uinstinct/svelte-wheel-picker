...
- **Global scope**: `/Users/instinct/Desktop/wheel-picker/svelte-wheel-picker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/instinct/Desktop/wheel-picker/svelte-wheel-picker/.claude/notes/`)
...
2. Glob `/Users/instinct/Desktop/wheel-picker/svelte-wheel-picker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/instinct/Desktop/wheel-picker/svelte-wheel-picker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/instinct/Desktop/wheel-picker/svelte-wheel-picker/.claude/notes/` — works in any directory
