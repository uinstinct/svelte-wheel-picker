...
<main>
	<section class="hero">
		...
		<p class="hero-description">
			An iOS-style wheel picker for Svelte 5 — smooth inertia scrolling, infinite loop,
			cylindrical 3D drum effect, and full keyboard navigation. Headless, zero dependencies,
			works via npm or the shadcn-svelte CLI.
		</p>
