...
Plans:
- [x] 04-01-PLAN.md — wrapIndex utility, infinite prop type, WheelPhysics infinite branches + unit tests
- [x] 04-02-PLAN.md — Ghost item rendering, keyboard wrapping, onSnap normalization, demo page
